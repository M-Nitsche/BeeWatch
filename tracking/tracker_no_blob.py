...
def run_no_blob_tracker(
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        frame = im0s # imutils.resize(img, width=1000)
        ...
        for i in range(0, len(blob_res_list)):
            sum_no_detected += 1
        ...
        if args_tr.show_info:
            ...
            text_det = "Blob " + str(len(blob_res_list)) + " " # YOLO BB from object detection
        ...
        if args_tr.yield_back:
            ...
            yield frame, len(blob_res_list), sum_no_detected, counter
...
if __name__=="__main__":
    ...
    for img in run_no_blob_tracker(opt, args):
        print("IMAGE")

...
Background subtraction is visualizing the substraction by coloring the background black and the foreground mask in white. Hence, the input image channel size is due to this reduction technique already reduced to 1, i.e. the images are grayscaled. Changing the YOLOv4 tiny model architecture to feedforward grayscale images was possible in the darknet framework without any circumstances by editing the config file. 
...
However this was not the end YOLO. In April 2020 **Alexey Bochkovsky et al.** introduced YOLOv4 in a paper titled: [YOLOv4: Optimal Speed and Accuracy of Object Detection] [33]. 
...
YOLOv4 gets its improvements through a selection and implementations of different BoF-methods like CutMix and Mosaic data augmentation, CIoU-loss, Optimal hyperameters (evolution) etc. and for BoS-methods mish activation and using multiple anchors for a single ground truth are used. Just to name a few - a full list and explanation can be found in the released paper ([Bochkovskiy et al., 2020](literature/Bochkovskiy%20et%20al.%20(2020)%20-%20YOLOv4:%20Optimal%20Speed%20and%20Accuracy%20of%20Object%20Detection.pdf)).[33]
...
[35] https://www.freecodecamp.org/news/7-cases-when-not-to-use-docker/ Date of retrieval: 17.07.2021
[36] https://www.infoworld.com/article/3310941/why-you-should-use-docker-and-containers.html: Date of retrieval: 17.07.2021
[37] https://www.geeksforgeeks.org/python-virtual-environment/ Date of retrieval: 17.07.2021
[38] https://docs.python.org/3/library/venv.html Date of retrieval: 17.07.2021

...
def json_to_csv(path, image_width, image_height):
    """Iterates through all the json file entries and combines
...
def main(_):
    ...
    examples = json_to_csv(args.json_dir, args.image_width, args.image_height)

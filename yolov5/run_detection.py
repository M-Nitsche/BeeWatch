...
class Detector(object):
    ...
    def __init__(self,
                 ...
                 source='../dataset/video_data/bees_demo1.mp4',  # file/dir/URL/glob, 0 for webcam
        ...
        self.save_img = not nosave and not source.endswith(
        ...
        if self.classify:
            ...
            self.modelc.load_state_dict(torch.load('resnet50.pt', map_location=device)[
    ...
    def run_detector_image(self, path, img, im0s, vid_cap, dataset):
        """
        Runs detection on a single image (which is already preprocessed to 0-1 pixel values)
